  ...
  return (
    <div className="flex w-full h-full">
      ...
      >
        ...
        <nav className="flex flex-col flex-1 w-full gap-1.5 xs:gap-2 sm:gap-3 md:gap-4 mt-2 xs:mt-3 sm:mt-6 md:mt-8 px-1 xs:px-2 overflow-y-auto custom-scrollbar">
          <SidebarItem
            icon={<HomeIcon />}
            label="INICIO"
